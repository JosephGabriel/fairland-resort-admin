...
export type BookingKeySpecifier = (
  | "bookingDate"
  | "dateIn"
  | "dateOut"
  | "id"
...
export type HotelsPayloadKeySpecifier = (
  | "count"
  | "nodes"
  | HotelsPayloadKeySpecifier
)[];
...
export type RoomPayloadKeySpecifier = (
  | "count"
  | "nodes"
  | RoomPayloadKeySpecifier
)[];
...
export type StrictTypedTypePolicies = {
  ...
  HotelsPayload?: Omit<TypePolicy, "fields" | "keyFields"> & {
    keyFields?:
      | false
      | HotelsPayloadKeySpecifier
      | (() => undefined | HotelsPayloadKeySpecifier);
  ...
  QueryPayload?: Omit<TypePolicy, "fields" | "keyFields"> & {
    keyFields?:
      | false
      | QueryPayloadKeySpecifier
      | (() => undefined | QueryPayloadKeySpecifier);
  ...
  RoomPayload?: Omit<TypePolicy, "fields" | "keyFields"> & {
    keyFields?:
      | false
      | RoomPayloadKeySpecifier
      | (() => undefined | RoomPayloadKeySpecifier);
